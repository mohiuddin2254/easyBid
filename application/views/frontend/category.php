...
<div class="product-item bg-light">
	<div class="card">
		<div class="thumb-content">
			...
			<a href="">
				<img class="card-img-top img-fluid" src="<?php echo base_url();?>assets/images/products/products-1.jpg" alt="Card image cap">
			</a>
		</div>
		<div class="card-body">
...
<div class="product-item bg-light">
	<div class="card">
		<div class="thumb-content">
			<!-- <div class="price">$200</div> -->
			<a href="">
				<img class="card-img-top img-fluid" src="<?php echo base_url();?>assets/images/products/products-2.jpg" alt="Card image cap">
			</a>
		</div>
		<div class="card-body">
...
<div class="product-item bg-light">
	<div class="card">
		<div class="thumb-content">
			<!-- <div class="price">$200</div> -->
			<a href="">
				<img class="card-img-top img-fluid" src="<?php echo base_url();?>assets/images/products/products-3.jpg" alt="Card image cap">
			</a>
		</div>
		<div class="card-body">
		    <h4 class="card-title"><a href="">11inch Macbook Air</a></h4>
