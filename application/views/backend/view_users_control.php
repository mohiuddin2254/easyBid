<div class="inner-block">
    <div class="blank">
    	<div class="blankpage-main">
			...
			<?php 
				if($this->session->userdata('user_type') == 'Adminx'){
			?>
						...
						<div class="modal-body">
							<form  action="<?php echo base_url();?>Users_control/editUser" method="post">
								...
								<div class="form-group">
									<div class="input-group">
										<div class="input-group-addon">Password</div>
										<input type="password" class="form-control" name="user_password" id="user_password_id" >
									</div>
								</div>
	...
	$("#user_discribe tr").click(function(event){
		...
		$.ajax({
			...
			success:function(result){
				...
				$('#user_password_id').val(result.user_password);
