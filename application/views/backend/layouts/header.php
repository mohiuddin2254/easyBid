...
<html>
<head>
<title><?php echo isset($title) ? $title : 'EasyBid - Admin Panel' ;
		?></title>
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left">
							<div class="logo-name">
									 <a target="_blank" href="<?php echo base_url();?>Home"> <h1>Easy Bid</h1> 
									...
									<li class="dropdown profile_details_drop">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
											<div class="profile_img">	
												<span class="prfil-img"><img src="<?php echo $this->session->userdata('user_pic');?>" class="img-responsive"> </span> 
												<div class="user-name">
